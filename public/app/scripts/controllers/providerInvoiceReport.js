...
.controller('ProviderInvoiceReportCtrl', function ($scope, $rootScope, toaster, providers, Invoice, $timeout, dialogs, statusList, companyList, Loading, Branch) {
	var today = new Date();
	$scope.isClient = $rootScope.userData.role._id != 1;
	$scope.selectedTab = 'countByClient';
	$scope.invoices = [];
	$scope.clientList = providers.data;
