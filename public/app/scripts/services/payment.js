...
.factory('Payment', function (Base, Item, $rootScope, $location, $q,$http, toaster, dialogs, Loading) {
	...
	var Payment;
	var a;
	function Payment(propValues) {
		a = document.createElement("a");
			document.body.appendChild(a);
		Payment.super.constructor.apply(this, arguments);
		this.baseApiPath = "/api/payment";
	...
	Payment.properties = function () {
		var at = {};
		return at;
	};
	
	
	Payment.prototype.goTo = function () {
		console.log(this)
	...
	Payment.prototype.download = function(){
		var d = $q.defer();
		var _this = this;
	...
	Payment.prototype.send = function(emails){
		var d = $q.defer();
		var _this = this;
	...
	Payment.prototype.sendTo = function(emails, sendToAllAdmin){
		var d = $q.defer();
		var _this = this;
		toaster.warning('Enviando el Correo');
	...
	Payment.prototype.getReport = function(query, queryDescription){
		var d = $q.defer();
		var _this = this;
		$http({
